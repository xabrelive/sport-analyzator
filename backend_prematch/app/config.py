...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql://sport:sport@localhost:12000/sport_analyzator"
    database_url_async: str | None = None

    # Redis
    redis_url: str = "redis://localhost:12000/0"

    # Auth
    secret_key: str = "change-me"
    algorithm: str = "HS256"
    access_token_expire_minutes: int = 60 * 24 * 7
    frontend_url: str = "http://localhost:12000"  # for email verification link
